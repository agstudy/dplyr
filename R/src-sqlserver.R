...
#' To connect to MS Sql Server database, you should provide either an url connection
#' or connection parameters (host,user,dbname,password,trusted,...)
#' 
#' @template db-info
#' @param url Connection String can be provided as an url
#' @param trusted If TRUE connection is trusted. No need to provide usr and password. 
...
#' @param src a sqlserver source created with \code{src_sqlserver}.
...
#' # here I am using a tusted connection (using windows authentication)
